...
export interface ScriptLine {
  text: string;
  requires?: RoleId[];
  /** If set, only show when this condition key is true */
  conditionKey?: string;
}
...
export const normalNightScript: ScriptLine[] = [
  {
    text: "(O {Cavaleiro Enferrujado} morreu, o Lobisomem mais próximo morre também)",
    requires: ["v07"],
    conditionKey: "cavaleiroDied",
  },
  {
    text: "(O {Caçador} morreu) O Fantasma do {Caçador} acorda e escolhe quem quer assassinar.",
    requires: ["v08"],
    conditionKey: "cacadorDied",
  },
  {
    text: "(O {Capuchinho Vermelho} foi executado) O {Caçador} acorda furioso e escolhe quem quer assassinar.",
    requires: ["v08"],
    conditionKey: "capuchinhoExecuted",
  },
  {
    text: "(O SOLDADO morreu) O Fantasma do {Soldado} acorda e escolhe quem quer assassinar.",
    conditionKey: "soldadoDied",
  },
  {
  ...
  {
    text: "(Um Inimigo morreu) O {Cupido Malvado} acorda e escolhe um segundo Inimigo. O {Cupido Malvado} adormece e os Inimigos serão tocados e podem se conhecer. Se um Inimigo consegue condenar o outro a execução, o primeiro recebe imunidade na próxima tentativa de assassinato.",
    requires: ["m05"],
    conditionKey: "enemyDied",
  },
  {
  ...
  },
  {
    ...
    requires: ["v20"],
    conditionKey: "empregadaVisible",
  },
  {
    text: "O {Piromaníaco} acorda. São-lhe mostradas as pessoas inocentadas no último tribunal. Ele decide, ao indicar ou mostrar o polegar para baixo, se quer ou não incendiar a casa de uma delas.",
    requires: ["v15"],
    conditionKey: "piromaniacoVisible",
  },
  {
  ...
  {
    text: "(Alguém morreu) A {Vidente} acorda e é-lhe revelado o papel dos mortos de ontem.",
    requires: ["e04"],
  },
  {
  ...
  },
  {
    ...
    requires: ["m01"],
    conditionKey: "lobisomemMauHasCharges",
  },
  // (Piromaníaco line moved earlier with conditionKey)
  {
  ...
  {
    text: "Os {Lobisomens} acordam e escolhem em conjunto uma vitima que irão assassinar esta noite.",
    requires: ["e01", "m01", "m02", "m03", "s02"],
  },
  {
    text: "O {Lobisomem Vidente} acorda e decide com o polegar se quer salvar a vítima para ver o seu papel ou deixá-la morrer.",
    requires: ["m02"],
    conditionKey: "lobisomemVidenteHasCharges",
  },
  {
    text: "O {Lobisomem Vampiro} acorda e diz com o polegar se quer transformar a vítima em Lobisomem. Se for o caso, a vítima será tocada, e passará a acordar sempre com os Lobisomens. A vítima diz com o polegar se quer guardar os seus poderes ou não.",
    requires: ["m03"],
    conditionKey: "vampiroHasCharges",
  },
  {
    text: "(A cada 3 noites) O {Lobisomem Branco} acorda e escolhe o Lobisomem que quer matar.",
    requires: ["s02"],
    conditionKey: "whitewolfNight",
  },
  {
  ...
  },
  {
    ...
    requires: ["e03"],
    conditionKey: "hasRedXPlayers",
  },
  {
    text: "A {Menina} acorda e vê como as vítimas desta noite morreram.",
    requires: ["v01"],
    conditionKey: "hasRedXPlayers",
  },
  {
    text: "O {Profeta} acorda e indica, ao apontar um jogador que acha que morreu esta noite. Se estiver correto, o jogador será tocado, para saber que pode guardar o seu poder, mesmo como Fantasma, durante o próximo dia e a noite.",
    requires: ["v19"],
    conditionKey: "hasRedXPlayers",
  },
  {
  ...
  {
    text: "O {Rouba-Túmulos} acorda e lhe são apresentadas as vítimas. Ele decide, ao indicar ou mostrar com o polegar para baixo, se quer ou não tomar o lugar de uma delas. Se escolher substituir uma das vítimas, o {Rouba-Túmulos} troca de poder com esse fantasma.",
    requires: ["a05"],
    conditionKey: "hasRedXPlayers",
  },
];
...
/**
 * Script order index for determining if a role appears before another.
 */
