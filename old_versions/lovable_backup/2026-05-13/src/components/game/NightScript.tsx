...
import { useLanguage, getScripts } from "@/lib/i18n";
...
export const NightScript = ({
  ...
  const sectionLabels = useMemo(() => {
    if (lang === "fr") {
      return { first: "Première Nuit", secondStart: "Début de la Deuxième Nuit", night: "Nuit" };
    }
    return { first: "Primeira Noite", secondStart: "Início da Segunda Noite", night: "Noite" };
  }, [lang]);
