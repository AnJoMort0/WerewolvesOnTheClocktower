    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      ...
      >
        <div className="space-y-2 relative">
          <a
            href={language === "fr"
              ? "https://github.com/AnJoMort0/WerewolvesOnTheClocktower/blob/main/Rulebook_FR.md"
              : "https://github.com/AnJoMort0/WerewolvesOnTheClocktower/blob/main/Rulebook_PT.md"}
            target="_blank"
      ...
      {isMenina && (
        <RevealModal open={meninaReveal} onClose={() => setMeninaReveal(false)} title={t("revealMeninaTitle", language)} subtitle={t("revealMeninaSubtitle", language)} cards={meninaCards} />
      )}
      {isFaroleiro && (
        <RevealModal open={faroleiroReveal} onClose={() => setFaroleiroReveal(false)} title={t("revealFaroleiroTitle", language)} subtitle={t("revealFaroleiroSubtitle", language)} cards={faroleiroCards} />
      )}
      {isLobisomemVidente && (
        <RevealModal open={lvReveal} onClose={() => setLvReveal(false)} title={t("revealLVTitle", language)} subtitle={t("revealLVSubtitle", language)} cards={lvCards} />
      )}
    </div>
    </LanguageContext.Provider>
  );
