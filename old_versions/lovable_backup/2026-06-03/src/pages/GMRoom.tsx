      ...
      if (roleAssignments[playerId] === CAVALEIRO_ROLE && _source !== "cavaleiro-linked") {
        ...
        if (isCavaleiroPoisoned) {
          ...
          if (nonWWAlive.length > 0) {
            ...
            toast.info(`O Cavaleiro Enferrujado estava envenenado! ${victim.name} foi infetado com Tétano.`);
          }
        } else {
          ...
          if (closestWW) {
            ...
            toast.info(`O Cavaleiro Enferrujado morreu! ${closestWW.name} foi infetado com Tétano.`);
          }
        }
      }
    ...
    if (role === CAVALEIRO_ROLE) {
      ...
      if (!isCavaleiroPoisoned) {
        ...
        if (closestWW) {
          ...
          setCavalerioLinkedDeath(closestWW.id);
          toast.info(`O Cavaleiro Enferrujado foi executado! ${closestWW.name} foi infetado com Tétano.`);
        }
      }
    }
