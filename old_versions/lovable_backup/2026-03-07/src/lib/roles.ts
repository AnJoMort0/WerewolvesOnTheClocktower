...
export type RoleId =
  ...
  | "v11" | "v12" | "v13" | "v14" | "v15" | "v18" | "v19" | "v20" | "v21" | "v22"
  | "m01" | "m02" | "m03" | "m04" | "m05"
  | "s01" | "s02"
  | "f01"
...
export function assignRoles(playerCount: number, advancedEnabled: boolean = false): RoleId[] {
  ...
  // 2. Werewolves: 1 basic e01, then fill with special werewolves, then more e01
  ...
  // 3. Randomly pick unique villager roles (max 1 each)
  ...
  // 4. Fill with other unique roles (m04, m05, s01, f01)
  ...
  // 5. Fill with lame roles: l02 first, then l03 (pair of 2), then l04 (trio of 3), then l01
